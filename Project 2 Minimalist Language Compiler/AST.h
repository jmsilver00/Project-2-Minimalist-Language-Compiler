//simple AST implementation, a struct 'AST' is defined
//AST struct represents a node in tree with 'nodeType' to indicate type of node
//string fields 'LHS' and 'RHS' store values of left and rights sides for binary operation
...
//creating AST node for binary expression 
...
//creating a AST node for funct call
...
//creating AST node for write statement 

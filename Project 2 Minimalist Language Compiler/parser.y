...
//defining header files and global variables for parser 
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int sum = 0;
int semanticCheckPassed = 1; //records correctness of semantic checks
%}

//defining set of data types to use in the parsing process 
%union {
	int number;
	char character;
	char* string;
...
//here token defines any needed terminal symbols within the grammer
%token <string> TYPE
%token <string> ID
...
//indicates how to print values of the specific data type 
%printer { fprintf(yyoutput, "%s", $$); } ID;
%printer { fprintf(yyoutput, "%d", $$); } NUMBER;

//type defines the types of non-terminal symbols within the grammer
...
Expr:	ID EQ RecursiveFunc { 
        ...
        | ID EQ ID 	{ 
			...
			//IR code will be printed to a separate file as well as MIPS code 
